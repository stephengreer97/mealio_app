// NOTE: AddConfirmation (was HebAddConfirmation) and confirmDetail moved to
// src/lib/cart-confirmation.ts on 2026-09-04. They are a contract every rail
// speaks and the shared engine reads, so they do not belong in one store's file.
